    ...
    <div className="min-h-[80vh] flex items-center justify-center px-5">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="mt-1.5 text-sm text-[#a0a0a0]">Reset your password</p>
        </div>
        ...
        {sent ? (
          <div className="bg-[#1a1a1a] border border-[#1f1f1f] rounded-xl p-6 text-center">
            ...
            <p className="text-xs text-[#6b6b6b] leading-relaxed">
              If an account exists for <span className="text-[#a0a0a0]">{email}</span>, we&apos;ve sent a link to reset your password. The link expires in 1 hour.
            </p>
          </div>
        ) : (
