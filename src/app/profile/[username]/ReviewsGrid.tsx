...
// Desktop: full review cards. Mobile: a grid of album-cover squares — tapping one
// opens the full review in a centered modal.
export default function ReviewsGrid({ reviews, isLoggedIn }: { reviews: ReviewData[]; isLoggedIn: boolean }) {
