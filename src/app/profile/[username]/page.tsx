...
import { isPremium, isPremiumActive } from "@/lib/premium";
    ...
    <div className="relative isolate max-w-4xl mx-auto px-5 py-12">
      ...
      <div className="flex items-start gap-5 pb-8 mb-8 border-b border-[#1f1f1f]">
        ...
        <div className="flex-1">
          ...
          {/* Edit profile sits below the stats; Settings took its place up by the
              name. SETLST Pro now lives in Settings. */}
          {isOwnProfile && (
            <div className="mt-4">
