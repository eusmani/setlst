    ...
    <div className="max-w-2xl mx-auto px-5 pt-5 pb-12">
      ...
      <div className="relative mb-6">
        <input
          ...
          className="w-full bg-[#222222] border border-[#2e2e2e] text-[#f0f0f0] rounded-lg pl-10 pr-3 py-3 text-sm focus:outline-none focus:border-[#c4a832] placeholder-[#6b6b6b] transition-colors"
        />
